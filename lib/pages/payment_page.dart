          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  AppButtons(icon: Icons.share,onPress: (){},text: "share",),
                  SizedBox(width: h*0.09,),
                  AppButtons(icon: Icons.print_outlined,onPress: (){},text: "Print",)
                ],
              ),
              SizedBox(height: h*0.02,),
              AppLargeButton(text: "Done",backGroundColor: Colors.white,textColor: AppColor.mainColor,onPress: (){Get.back();},)
